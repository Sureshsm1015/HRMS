...
urlpatterns = [
    ...
    path("recruitment-search", recruitment.views.search.recruitment_search, name="recruitment-search"),
    path("recruitment-update/<int:rec_id>/", views.recruitment_update, name="recruitment-update"),
    path(
    ...
    path("linkedin-integration-setting", cbvs.LinkedinSettingSectionView.as_view(),name="linkedin-integration-setting"),
    path("linkedin-setting-nav", cbvs.LinkedInSettingNavView.as_view(), name="linkedin-setting-nav"),
    path("linkedin-setting-list", cbvs.LinkedInSettingListView.as_view(), name="linkedin-setting-list"),
    path("create-linkedin-account", cbvs.LinkedInAccountFormView.as_view(), name="create-linkedin-account"),
    path("update-linkedin-account/<int:pk>/", cbvs.LinkedInAccountFormView.as_view(), name="update-linkedin-account"),
    path("delete-linkedin-account/<int:pk>/", linkedin.delete_linkedin_account, name="delete-linkedin-account"),
    path("update-isactive-linkedin-account/<int:obj_id>", linkedin.update_isactive_linkedin, name="update-isactive-linkedin-account"),
    path("check-linkedin", linkedin.check_linkedin, name="check-linkedin"),
    path("val-linkedin/<int:pk>/", linkedin.validate_linkedin_token, name="val-linkedin"),
]
